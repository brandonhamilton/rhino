...
#define MUX_RHINO() \
	...
	MUX_VAL(CP(GPMC_WAIT1),		(IEN  | PTD | EN  | M0)) \
	...
	MUX_VAL(CP(MMC1_DAT4),		(IDIS | PTU | DIS | M4)) /*GPIO_126*/\
	MUX_VAL(CP(MMC1_DAT5),		(IEN  | PTU | DIS | M4)) /*GPIO_127*/\
	MUX_VAL(CP(MMC1_DAT6),		(IEN  | PTU | DIS | M4)) /*GPIO_128*/\
	MUX_VAL(CP(MMC1_DAT7),		(IDIS | PTU | DIS | M4)) /*GPIO_129*/\
	\
	/* MMC2 */ \
	\
...
#define MUX_RHINO() \
	...
	MUX_VAL(CP(SYS_CLKREQ),		(IEN  | PTD | DIS | M0)) \
	MUX_VAL(CP(SYS_NIRQ),		(IEN  | PTU | EN  | M0)) \
	MUX_VAL(CP(SYS_NRESWARM),   	(IDIS | PTU | DIS | M4)) /*GPIO_30*/\
	\
	MUX_VAL(CP(SYS_BOOT0),		(IEN  | PTD | DIS | M4)) /*GPIO_2*/\
	MUX_VAL(CP(SYS_BOOT1),		(IEN  | PTD | DIS | M4)) /*GPIO_3 */\
	MUX_VAL(CP(SYS_BOOT2),		(IEN  | PTD | DIS | M4)) /*GPIO_4*/\
