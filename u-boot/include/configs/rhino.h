...
#include "rhino_revision.h"
#ifndef CONFIG_RHINO_REV
...
#define CONFIG_SERIAL1			1	/* UART1 on RHINO */
...
#define CONFIG_USBD_PRODUCT_NAME	"RHINO"
...
#define CONFIG_CMD_SPI		/* SPI support */
...
#define CONFIG_OMAP24XX_I2C_WORD_ACCESS
...
#define CONFIG_JFFS2_PART_OFFSET	0x680000   /* space to store x-loader and u-boot */
#define CONFIG_JFFS2_PART_SIZE		0xf980000	/* sz of jffs2 part = 256M*/
...
#define CONFIG_SYS_MEMTEST_END		(OMAP34XX_SDRC_CS0 + 0x0FFFFFFF)
#define CONFIG_SYS_ALT_MEMTEST
#define CONFIG_SYS_MEMTEST_SCRATCH  (OMAP34XX_SDRC_CS0 + 0x00FFFFF0)
 ...
 * Physical Memory Map
 */
#define CONFIG_NR_DRAM_BANKS    2           /* Code crashes if set to 1 */
