...
#define GPMC_ECC_CONFIG		(OMAP34XX_GPMC_BASE+0x1F4)
#define GPMC_ECC_CONTROL	(OMAP34XX_GPMC_BASE+0x1F8)
#define GPMC_ECC_SIZE_CONFIG	(OMAP34XX_GPMC_BASE+0x1FC)
#define GPMC_ECC1_RESULT	(OMAP34XX_GPMC_BASE+0x200)
#define GPMC_ECC2_RESULT	(OMAP34XX_GPMC_BASE+0x204)
#define GPMC_ECC3_RESULT	(OMAP34XX_GPMC_BASE+0x208)
#define GPMC_ECC4_RESULT	(OMAP34XX_GPMC_BASE+0x20C)
#define GPMC_ECC5_RESULT	(OMAP34XX_GPMC_BASE+0x210)
#define GPMC_ECC6_RESULT	(OMAP34XX_GPMC_BASE+0x214)
#define GPMC_ECC7_RESULT	(OMAP34XX_GPMC_BASE+0x218)
#define GPMC_ECC8_RESULT	(OMAP34XX_GPMC_BASE+0x21C)
#define GPMC_ECC9_RESULT	(OMAP34XX_GPMC_BASE+0x220)
