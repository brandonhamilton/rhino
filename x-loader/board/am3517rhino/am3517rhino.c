...
/*Set TIM2_T_ODT to 0x1 for am3517rhino. Was 0x0 for am3517evm*/
#define	EMIF4_TIM2_T_ODT	0x1
#define	EMIF4_TIM2_T_XSNR	0x1C
#define	EMIF4_TIM2_T_XSRD	0xC8
#define	EMIF4_TIM2_T_RTP	0x1
#define	EMIF4_TIM2_T_CKE	0x2

/*Note: EMIF4_TIM3_T_TDQSCKMAX is not used on AM3517, and hence zero*/
...
/*If problems, decrease 0x50F slightly to increase refresh rate*/
...
/*Possibly enable DDR_TERM to improve signal integrity*/
#define	EMIF4_CFG_DDR_TERM	0x0
#define	EMIF4_CFG_DDR2_DDQS	0x1
/*DYN_ODT is not implemented on AM3517*/
...
u32 get_mem_type(void)
{
        ...
        switch (mem_type){
            ...
            case 1:		return GPMC_NAND;
            case 9:		return MMC_NAND;
...
/*********************************************************************
 * config_emif4_ddr() - Init/Configure DDR on AM3517 RHINO board.
 *********************************************************************/
...
#define MUX_DEFAULT()\
    ...
    \
    /*GPMC Controller for NAND flash */\
    \
    ...
    \
    /*UART1 for terminal and UART2 for debugging*/\
    \
	...
	MUX_VAL(CP(JTAG_TDI),       (IEN  | PTD | EN  | M0)) /*JTAG_TDI*/\
